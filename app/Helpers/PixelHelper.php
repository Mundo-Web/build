...
";
        ...
        if (!empty($lazyScripts)) {
            $headScripts .= "
<!-- Lazy Loaded Pixels and Analytics -->
<script>
(function() {
    ...
    function initPixels() {
        ...
        window.removeEventListener('scroll', initPixels);
        window.removeEventListener('mousemove', initPixels);
        window.removeEventListener('touchstart', initPixels);
        window.removeEventListener('keydown', initPixels);
    ...
    // Load after 3.5s or on first user interaction
    var timer = setTimeout(initPixels, 3500);
    window.addEventListener('scroll', initPixels, {passive: true});
    window.addEventListener('mousemove', initPixels, {passive: true});
    window.addEventListener('touchstart', initPixels, {passive: true});
    window.addEventListener('keydown', initPixels, {passive: true});
})();
</script>
";
        }
