...
class WelcomeProviderNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $body = $template
            ...
            : "Bienvenido a Rainstar, {$this->name}. Tu cuenta de proveedor ha sido creada. Usuario: {$this->email}, Contraseña: {$this->password}. Puedes iniciar sesión en " . url('/login');

        return (new \App\Mail\RawHtmlMail($body, 'Bienvenido a Rainstar - Tu cuenta de proveedor ha sido creada', $this->email));
    }
}
