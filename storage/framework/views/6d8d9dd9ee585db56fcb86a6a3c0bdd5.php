...
<head>
    ...
    <?php
        ...
        $item = null;
        if ($isDetailPage && isset($data[$modelName]) && $data[$modelName]) {
            $item = $data[$modelName];
        }
        if ($item) {
            ...
            // Obtener el nombre de la tabla en snake_case para la ruta de la imagen
...
<?php /**PATH C:\xampp\htdocs\projects\rainstarstore\resources\views/public.blade.php ENDPATH**/ ?>