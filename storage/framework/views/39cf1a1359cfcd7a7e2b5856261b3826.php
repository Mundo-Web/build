...
<head>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($route == 'Admin/Gallery.jsx'): ?>
    ...
    <style>
        :root {
            --menu-admin-color: <?php echo e($menuAdminColor); ?>;
            --menu-admin-text-color: <?php echo e($textColor); ?>;
        }
...
<body class="loading"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($route == 'home'): ?>
...
<?php /**PATH C:\xampp\htdocs\projects\cormarsuministros\resources\views/admin.blade.php ENDPATH**/ ?>