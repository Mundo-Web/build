...
import ItemVariantsManager from "../Admin/ItemAdminComponents/ItemVariantsManager";
import ItemsRest from "../Actions/Provider/ItemsRest";
                    ...
                    },
                    {
                        ...
                        cellTemplate: (container, { data }) => {
                            ...
                            ReactAppend(
                                container,
                                <span
                                    className={`badge ${classNames[status]} rounded-pill`}
                                >
                                    {labels[status]}
                                </span>,
                            );
...
CreateReactScript((el, properties) => {
    createRoot(el).render(
        <BaseAdminto {...properties} title="Mis Productos">
            <Items {...properties} />
        </BaseAdminto>,
    );
});
