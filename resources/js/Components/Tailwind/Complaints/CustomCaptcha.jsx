            ...
            if (err.response?.status === 429) {
                ...
                setLocalError(
                    err.response?.data?.error ||
                        "Error al cargar CAPTCHA. Intenta nuevamente.",
                );
            }
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-center">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                    <div className="relative w-full sm:min-w-[200px] lg:min-w-[300px]">
                        {isLoading && !captchaImage ? (
                            ...
                            <img
                                src={captchaImage}
                                alt="CAPTCHA"
                                className="w-full h-auto border-2 border-gray-300 rounded-lg select-none pointer-events-none"
                                draggable="false"
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="flex items-center justify-center p-3 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors duration-200 group disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
                        title="Generar nuevo código"
                    >
                        <RefreshCw
                            className={`w-5 h-5 text-gray-600 group-hover:rotate-180 transition-transform duration-300 ${isLoading ? "animate-spin" : ""}`}
                        />
                    </button>
                </div>
            ...
            <p className="text-xs customtext-neutral-light">
                Ingresa exactamente el código que aparece en la imagen. No
