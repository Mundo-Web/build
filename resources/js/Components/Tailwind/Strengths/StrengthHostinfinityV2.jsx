...
const StrengthHostinfinityV2 = ({ items = [], data = {} }) => {
                                    ...
                                    >
                                        ...
                                        `}>
                                            ...
                                            <div className="relative flex flex-col items-center text-center h-full">
                                                ...
                                                >
                                                    {/* Glow del icono */}
                                                    <div className="absolute inset-0 rounded-full blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-100" />
                                                ...
                                                {/* Título */}
                                                <h3 className="text-4xl lg:text-4xl text-white mb-4 tracking-tight transition-colors duration-100">
                                                    <TextWithHighlight text={strength.name} color="bg-secondary" />
                                                </h3>

                                                {/* Descripción */}
                                                <p className="text-lg text-neutral-dark font-light leading-relaxed flex-1 group-hover:text-white/80 transition-colors duration-100">
                                                    <TextWithHighlight text={strength.description} color="bg-secondary" />
                                                </p>
                                            </div>

                                            {/* Partícula decorativa */}
                                            <div className="absolute -bottom-2 -right-2 w-24 h-24 bg-gradient-to-br from-secondary/20 to-transparent rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-100" />
                                        </div>
                                    </motion.div>
                                </SwiperSlide>
                            );
...
export default StrengthHostinfinityV2;
