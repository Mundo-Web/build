            ...
            <main className="w-11/12 mx-auto max-w-[868px] pb-16">
                <div className="flex flex-col gap-10 py-10 ">
                    ...
                    <div className="flex flex-col gap-2 customtext-primary">
                        <h2 className="font-paragraph text-3xl xl:text-6xl font-bold text-center leading-tight">
                            ¡Gracias por contactarnos!
                        </h2>

                        <p className="text-[#1d1d1d] font-paragraph font-normal text-center text-base xl:text-xl">
                    ...
                    <div className="flex flex-col">
                        <div className="flex justify-center items-center">
                            <a href="/"
                                className="text-white font-paragraph font-bold text-base py-3 px-6 bg-primary rounded-full">Seguir
                                navegando</a>
                        </div>
                    </div>
                </div>
