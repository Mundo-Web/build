...
const WhatsAppSeller = ({ data, referrer }) => {
    const [isDropdownOpen, setIsDropdownOpen] = useState(false);
    const dropdownRef = useRef(null);

    // Obtener asesores de WhatsApp (Fallback a General)
    let defaultAdvisors = General.whatsapp_advisors || [];
    let advisors = [...defaultAdvisors];

    // Si tenemos un referrer (asesor del smart-link), lo usamos como el único asesor
    if (referrer && referrer.phone) {
        const phoneToUse = referrer.whatsapp_number
            ? referrer.whatsapp_number
            : (referrer.phone_prefix || "") + referrer.phone;
        const autoMessage =
            referrer.whatsapp_message ||
            "¡Hola! Vengo de tu enlace de referido y necesito información sobre Rainstar.";
        advisors = [
            {
                name:
                    referrer.name +
                ...
                phone: phoneToUse,
                message: autoMessage,
                photo: referrer.photo || null,
                position: "Tu Vendedor Personal",
            },
        ];
    }
        ...
        >
            <div className="fixed bottom-[5%] right-[5%] z-20">
                ...
                >
                    ...
                    {/* Imagen de WhatsApp con movimiento flotante */}
                    <motion.img
