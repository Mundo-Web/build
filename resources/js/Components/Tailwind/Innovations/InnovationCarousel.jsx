...
const InnovationCarousel = ({ data, items = [] }) => {
        ...
        <section className="py-12" style={{ backgroundColor: data?.bg_color }}>
            <div className="max-w-7xl mx-auto px-[5%] 2xl:px-0">
                ...
                {activeItems.length > 0 && (
                    ...
                    >
                        {activeItems.map((innovation, index) => (
                            <SwiperSlide key={innovation.id || index}>
                ...
                <div className="swiper-button-prev-innovation absolute left-0 top-1/2 -translate-y-1/2 w-12 h-12 bg-primary rounded-full flex items-center justify-center cursor-pointer z-10 hover:bg-primary/80 transition-colors">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                    </svg>
                </div>
                <div className="swiper-button-next-innovation absolute right-0 top-1/2 -translate-y-1/2 w-12 h-12 bg-primary rounded-full flex items-center justify-center cursor-pointer z-10 hover:bg-primary/80 transition-colors">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
