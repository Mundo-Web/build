    ...
    return (
        <>
            <header
                ...
                className={`w-full left-0 z-50 sticky top-0 transition-all duration-300 ease-in-out ${isFixed
                    ? "bg-white shadow-sm border-b border-gray-100 text-black"
                    : "bg-white text-black"
                    } ${data?.class || ""}`}
            >
                ...
                <div
                    className={`w-full  ${isFixed ? "py-6" : "py-6"
                        }`}
                >
