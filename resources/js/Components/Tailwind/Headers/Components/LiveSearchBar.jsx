    ...
    return (
        <div className="relative w-96" ref={containerRef}>
            ...
            <a
                ...
                className="absolute flex gap-2 right-2 top-1/2 transform -translate-y-1/2 py-3 px-6 bg-accent text-white rounded-full"
                aria-label="Buscar"
            >
                Buscar
            </a>
            ...
            {showDropdown && (
                <div className="absolute mt-2 w-full bg-white border rounded-lg shadow-lg z-50 max-h-60 overflow-y-auto">
                    {loading ? (
                        <div className="px-4 py-2 text-neutral-light">
                            Buscando...
                        </div>
                    ) : filtered.length > 0 ? (
                                ...
                                >
                                    <div className="flex items-center gap-3 px-2 py-2">
                                        ...
                                        <div className="text-right text-sm min-w-[80px] customtext-neutral-dark">
                                            ...
                                            {discount > 0 && (
                                                <p className="text-xs text-neutral-light line-through">
                                                    {CurrencySymbol()}{" "}
                                                    {price.toFixed(2)}
                                                </p>
                                            )}
