      ...
      return (
        <nav className="space-y-1">
          ...
          {pages.map((page, index) => (
            page.menuable && (page.name !== "Blogs" || headerPosts.length > 0) && (
          ...
          <div className="pb-4 border-b border-gray-100 mb-4">
            ...
            >
              <ChevronRight className="h-4 w-4 rotate-180" />
                     <h3 className="text-lg font-semibold text-gray-800 px-2">Categorías</h3>
      ...
      return (
        <div className="space-y-1">
          <div className="pb-4 border-b border-gray-100 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800 px-2">{selectedCategory}</h3>
          </div>
