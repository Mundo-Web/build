...
const FooterIbergruas = ({ pages, generals, data, socials = [] }) => {
  ...
  <>
                                            <div className={`fill-secondary ${data?.class_icon || ''}`}>
                                                <svg
                ...
                {/* Newsletter Column */}
                <div className="mt-4 lg:mt-0 col-span-1 md:col-span-1 ">
                   
                    <div className="">
                        <h3 className={`customtext-primary font-bold mb-6 text-base ${data?.class_menu || ''}`}>Nuestras redes</h3>
            ...
            {Object.keys(policyItems).map((key, index) => {
                ...
                return (
                    <ReactModal
                        ...
                        contentLabel={title}
                        className="fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center p-4 z-[999999]"
...
export default FooterIbergruas;
