    ...
    const companyLinks = (() => {
        try {
            const links = generals.find(
                (g) => g.correlative === "footer_company_links",
            )?.description;
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-white leading-relaxed text-lg mb-4">
                            {footerDescription ||
                                `Líderes en distribución de productos de alta calidad para profesionales que exigen lo mejor.`}
                        </p>
                    ...
                    >
                        ...
                        <ul className="space-y-3 text-gray-300">
                            ...
                            {openingHours && (
                                <li className="flex items-start gap-3">
                                    <svg
                                        className="w-5 h-5 text-wood-300 flex-shrink-0 mt-0.5"
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                    >
