...
import { ChevronsRight, CircleCheckBig, X } from "lucide-react";
                        ...
                        <ul className={`space-y-3 text-white ${data?.class_menu_list || ''}`}>
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    {data?.sticker_book_reclamations && (
                ...
                <div className="mt-4 lg:mt-0 col-span-1 md:col-span-2">
                    ...
                    <form onSubmit={onEmailSubmit}>
                        <div className="relative customtext-neutral-dark">
                            ...
                            <button
                                disabled={saving}
                                className={`absolute right-3 top-1/2 transform -translate-y-1/2 py-3 font-bold shadow-xl px-4 rounded-xl flex items-center justify-center ${data?.type_button_subscriber === 'icon'
                                    ? 'min-w-[48px] w-14 h-14 !p-0 !rounded-full !right-0'
                                    : 'min-w-[120px]'
                                    } ${data?.class_button || 'bg-primary text-white'}`}
                            ...
                            >
                                {saving ? (
                                    <span className="flex items-center gap-2">
                                        ...
                                        {data?.type_button_subscriber !== 'icon' && "Enviando..."}
                                    </span>
                                ) : (
                                    data?.type_button_subscriber === 'icon' ? (
                                        <ChevronsRight strokeWidth={2} className="w-20" />
