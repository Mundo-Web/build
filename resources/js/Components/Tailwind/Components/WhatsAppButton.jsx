...
import WhatsAppModal from "../Floating/WhatsAppModal";

/**
 * Componente reutilizable para botones de WhatsApp
 * Soporta un solo asesor (abre directo) o múltiples asesores (muestra modal)
 * 
 * @param {Object} props
 * @param {string} props.className - Clases CSS personalizadas
 * @param {React.ReactNode} props.children - Contenido del botón
 * @param {boolean} props.showIcon - Mostrar icono de WhatsApp
 * @param {string} props.text - Texto del botón (opcional)
 */
const WhatsAppButton = ({ className = "", children, showIcon = true, text = "" }) => {
    ...
    const handleClick = (e) => {
        ...
        if (advisors.length === 1) {
            ...
            // Si hay múltiples asesores, mostrar modal
            e.preventDefault();
            setIsModalOpen(true);
        }
    };
    ...
    // Si se proporcionan children, usarlos; de lo contrario, crear botón predeterminado
