...
const BannerSimpleSF = ({ data }) => {
    ...
    return (
        <section id={data?.element_id || null} className="px-[5%] 2xl:px-0 2xl:max-w-7xl mx-auto bg-white py-12 xl:py-10">
                ...
                <div className="flex flex-col gap-5 py-8 lg:py-16 px-8 lg:pl-16 xl:pl-20  justify-start items-start w-full max-w-xl 2xl:max-w-3xl text-white text-left">
                    ...
                    {data?.button_link && data?.button_text && (
                        <div className="flex flex-col">
                            <a href={data?.button_link} className="w-auto bg-accent px-6 py-3 2xl:py-4 2xl:px-8 rounded-3xl text-white font-paragraph leading-none text-base 2xl:text-xl">
                                {data?.button_text}
                            </a>
                        </div>
                    )}
