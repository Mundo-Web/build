            ...
            <div className="bg-secondary px-primary 2xl:px-0 2xl:max-w-7xl mx-auto rounded-lg md:rounded-xl shadow-sm">
                ...
                <div className="mb-4 md:mb-8">
                    <div className="flex items-center justify-between gap-1 md:gap-4 max-w-3xl mx-auto">
                        <div className={`flex flex-col items-center md:flex-row md:items-center gap-1 md:gap-2 ${currentStep >=1 ? `customtext-primary font-medium` : "text-white"}`}>
                        ...
                        <div className={`flex flex-col items-center md:flex-row md:items-center gap-1 md:gap-2 ${currentStep === 3 ? `${data?.gradient ? 'customtext-gradient' : 'customtext-primary'} font-medium` : "text-white"}`}>
