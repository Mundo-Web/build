...
export default function CartStepPidelo({ 
    data,
    cart, 
    setCart, 
    onContinue, 
    ...
    generals,
    // Nuevas props para mostrar desglose del derecho arancelario
    valorCIF,
    advDisplay,
    ipmDisplay,
        ...
        <div className="grid lg:grid-cols-5 gap-4 md:gap-8">
            ...
            <div className="lg:col-span-2 bg-[#F7F9FB] rounded-xl shadow-lg p-4 md:p-6 h-max mt-4 md:mt-0">
                ...
                <div className="space-y-3 md:space-y-4">
                    ...
                    {/* Mostrar descuentos aplicados al subtotal */}
                    {totalDiscount > 0 && (
                        <div className="flex justify-between text-green-600">
                            <span className="customtext-neutral-dark">Descuentos aplicados</span>
                            <span className="font-semibold">-{CurrencySymbol()}{Number2Currency(totalDiscount)}</span>
                        </div>
                    )}
                    ...
                    {totalDiscount > 0 && (
                        <div className="flex justify-between border-t pt-2">
                            ...
                            <span className="font-semibold">{CurrencySymbol()}{Number2Currency(subTotalConDescuentos || (subTotal - totalDiscount))}</span>
                        </div>
                    )}
