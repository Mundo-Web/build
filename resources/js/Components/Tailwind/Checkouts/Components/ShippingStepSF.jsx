        ...
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-y-8 lg:gap-8 ">
                <div className="lg:col-span-3">
                    ...
                    >
                        <div className="sectionInformation space-y-3.5">
                            <h3
                                className={`block text-xl 2xl:text-2xl font-bold mb-4 customtext-neutral-dark `}
                            >
                ...
                <div className="bg-[#F7F9FB] rounded-xl shadow-lg p-6 col-span-2 h-max font-paragraph">
                    <h3 className="text-2xl font-bold pb-6 customtext-neutral-dark">
                        Resumen de compra
                    </h3>
                    ...
                    <div className="space-y-4 mt-6">
                        ...
                        {autoDiscountTotal > 0 && (
                            <div className="flex justify-between text-green-600">
                                ...
                                <span className="font-semibold">
                                    -{CurrencySymbol()}{" "}
                                    {Number2Currency(autoDiscountTotal)}
                                </span>
                            </div>
                        )}
                        ...
                        {appliedCoupon && (
                            <div className="flex justify-between text-blue-600">
                                ...
                                <span className="font-semibold">
                                    -{CurrencySymbol()}{" "}
                                    {Number2Currency(calculatedCouponDiscount)}
                                </span>
                            </div>
                        )}
                        <div className="flex justify-between">
                            ...
                            <span className="font-semibold">
                                {(() => {
                                    ...
                                    if (
                                        ...
                                        return (
                                            <span className="customtext-neutral-dark text-sm">
                                                Pago en destino
                                            </span>
                                        );
                                    }
                        ...
                        {additionalShippingCost > 0 && (
                            <div className="flex justify-between text-danger">
                                ...
                                <span className="font-semibold">
                                    +{CurrencySymbol()}{" "}
                                    {Number2Currency(additionalShippingCost)}
                                </span>
                            </div>
                        )}
                        ...
                        {paymentCommission > 0 && selectedPaymentMethod && (
                            <div className="flex justify-between text-yellow-600">
                                ...
                                <span className="font-semibold">
                                    +{CurrencySymbol()}{" "}
                                    {Number2Currency(calculatedCommission)}
                                </span>
                            </div>
                        )}
