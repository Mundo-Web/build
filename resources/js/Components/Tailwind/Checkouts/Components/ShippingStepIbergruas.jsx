...
import PaymentModalIbergruas from "./PaymentModalIbergruas";
...
export default function ShippingStepIbergruas({
    cart,
    setSale,
    setCode,
    setDelivery,
    ...
    useEffect(() => {
        ...
        if (user?.ubigeo) {
                ...
                fetch(`/api/ubigeo/find/${user.ubigeo}`)
                    ...
                    .then(data => {
                        if (data && data.distrito) {
                            ...
                            console.log('❌ ShippingStepIbergruas - No se encontró ubicación para ubigeo:', user.ubigeo);
                        }
                    })
                    .catch(error => {
                        console.error('❌ ShippingStepIbergruas - Error al buscar ubicación:', error);
                    });
            } else {
            ...
            console.log('❌ ShippingStepIbergruas - Usuario sin ubigeo registrado');
        }
    }, [user]);
        ...
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-y-8 lg:gap-8 ">
                <div className="lg:col-span-3">
                    {/* Formulario */}
                    <form
                        className="space-y-6 bg-transparent text-white py-6 px-4 sm:px-6 rounded-2xl font-paragraph"
                        onSubmit={(e) => e.preventDefault()}
                    >
                        <div className="sectionInformation space-y-3.5">
                            <h3 className={`block text-xl 2xl:text-2xl font-bold mb-4 c `}>
                            ...
                            <div className="grid lg:grid-cols-2 gap-4">
                                ...
                                <InputForm
                                    ...
                                    className="!rounded-none bg-transparent text-white"
                                />
                                {/* Apellidos */}
                                <InputForm
                                    label="Apellidos"
                            ...
                            <div className="grid lg:grid-cols-2 gap-4 ">
                                ...
                                <div className="w-full">
                                    <label htmlFor="phone" className="block text-sm 2xl:text-base mb-1 c">
                        ...
                        <div className="sectionDelivery space-y-3.5">
                            ...
                            <div id="ubigeo-select-container" className="form-group">
                                <label
                                    className={`block text-sm 2xl:text-base mb-1 c `}
                                >
                        ...
                        <div className="space-y-2">
                            <label className="block text-sm font-medium c">
                                Tipo de comprobante
                            </label>
                            <div className="flex gap-4">
                                <label className="inline-flex items-center cursor-pointer group">
                                    ...
                                    <span className="ml-3 text-sm font-medium c">Boleta</span>
                                </label>
                                <label className="inline-flex items-center cursor-pointer group">
                                    <div className="relative">
                                        <input
                                    ...
                                    <span className="ml-3 text-sm font-medium c">Factura</span>
                                </label>
                            </div>
                        </div>
                ...
                {/* Resumen de compra */}
                <div className="bg-transparent rounded-none border text-white border-primary p-6 col-span-2 h-max font-paragraph">
                    <h3 className="text-2xl font-bold pb-6 c">Resumen de compra</h3>
                        ...
                        {cart.map((item, index) => (
                            <div key={item.id} className="rounded-lg">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        <h3 className="font-semibold c text-base 2xl:text-lg mb-2">
                                            {item.name}
                                        </h3>
                            ...
                            <div>
                                <div className="flex">
                                    <input
                                        ...
                                        className={`w-full rounded-none bg-transparent border py-3 px-4 text-sm outline-none uppercase focus:border-[#C5B8D4] ${
                                    ...
                                    />
                                    <button
                                        className={`rounded-none  px-4 py-2 text-sm text-white transition-all duration-300 hover:opacity-90 ${
                                            couponLoading 
