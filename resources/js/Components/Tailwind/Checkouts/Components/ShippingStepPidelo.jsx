...
export default function ShippingStepPidelo({
    data,
    cart,
    setSale,
    setCode,
    ...
    // Calcular el total base antes de cupón usando la nueva lógica
    const totalBase = roundToTwoDecimals(totalFinal) - roundToTwoDecimals(automaticDiscountTotal);
                ...
                <div className="space-y-4 mt-6">
                    ...
                    {automaticDiscountTotal > 0 && (
                        <div className="flex justify-between text-green-600">
                            ...
                            <span>-{CurrencySymbol()}{Number2Currency(roundToTwoDecimals(automaticDiscountTotal))}</span>
                        </div>
                    )}
                    ...
                    <div className="pt-4 border-t-2">
                        <div className="flex justify-between font-bold text-lg">
                            <span>Total:</span>
                            <span>{CurrencySymbol()}{Number2Currency(roundToTwoDecimals(appliedCoupon ? finalTotalWithCoupon : totalFinal))}</span>
                        </div>
                    </div>
                    ...
                    >
                        {paymentLoading ? "Procesando..." : !Global.CULQI_ENABLED ? "Pago no disponible" : !Global.CULQI_PUBLIC_KEY ? "Configuración pendiente" : `Pagar ${CurrencySymbol()}${Number2Currency(roundToTwoDecimals(appliedCoupon ? finalTotalWithCoupon : totalFinal))}`}
                    </ButtonPrimary>
