                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    maxLength="19"
                                    className={`w-full px-4 py-3 2xl:py-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-base 2xl:text-lg ${errors.card_number ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                    disabled={loading}
                                />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-3 2xl:py-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-base 2xl:text-lg ${errors.holder_name ? 'border-red-500' : 'border-gray-300'
                                    }`}
                                disabled={loading}
                            />
                            {errors.holder_name && (
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="MM"
                                    maxLength="2"
                                    className={`w-full px-4 py-3 2xl:py-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-base 2xl:text-lg text-center ${errors.expiration_month ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                    disabled={loading}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="YY"
                                    maxLength="2"
                                    className={`w-full px-4 py-3 2xl:py-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-base 2xl:text-lg text-center ${errors.expiration_year ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                    disabled={loading}
                                />
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="123"
                                    maxLength="4"
                                    className={`w-full px-4 py-3 2xl:py-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-base 2xl:text-lg text-center ${errors.cvv2 ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                    disabled={loading}
                                />
                                {errors.cvv2 && (
