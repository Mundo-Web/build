...
import { CircleX, X, Upload } from "lucide-react";

const salesRest = new SalesRest();

export default function UploadVoucherModalYapeTwenty({
    isOpen,
    onClose,
    onUpload,
    paymentMethod,
        ...
        >
            <div className="py-6 px-8 flex flex-col gap-4 max-h-[90vh] md:max-h-[85vh] overflow-y-auto scrollbar-thin scrollbar-thumb-white/10">
                ...
                <h2 className="text-sm font-paragraph uppercase tracking-widest text-center text-white font-bold mt-2">
                    {General.get('checkout_dwallet_name') || "Pago Digital"}
                </h2>
                ...
                <div className="w-full flex flex-row items-center justify-center my-2">
                    <Tippy content="Escanee código QR para pagar">
                        <div className="border border-white/10 p-2 bg-white">
                            <img 
                            ...
                            <div key={item.id} className="rounded-none bg-transparent">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-[9px] font-paragraph uppercase tracking-wider text-white/40">
