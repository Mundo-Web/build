...
export default function CartStepIbergruas({
    ...
    return (
        <div className="grid lg:grid-cols-5 gap-4 md:gap-8">
            ...
            {/* Checkout Summary */}
            <div className="lg:col-span-2 bg-transparent border text-white  border-primary  p-4 md:p-6 h-max mt-4 md:mt-0">
                ...
                <div className="space-y-3 md:space-y-4">
                    ...
                    {isLoadingDiscounts && (
                        <div className="flex justify-between items-center">
                            <span className="text-white">Verificando descuentos...</span>
                    ...
                    {!isLoadingDiscounts && appliedDiscounts.length > 0 && (
                        <div className="space-y-2">
                            <div className="text-xl md:text-2xl font-bold pb-4 md:pb-6 text-white mb-2">
                    ...
                    <div className="space-y-2 pt-3 md:pt-4">
                        <ButtonPrimary
                            ...
                            className={`w-full py-3 px-6 font-semibold focus:outline-none outline-none focus:border-0 text-lg transition-all duration-300 hover:opacity-90 bg-primary   !rounded-none  ${data?.class_button || ' customtext-neutral-dark'}`}
                        >
                            {isCartEmpty ? 'Carrito Vacío' : 'Continuar Compra'}
                        </ButtonPrimary>
                        <ButtonSecondary href="/" className="w-full !rounded-none">
