...
const ServiceLaPetaca = ({ data, items }) => {
    ...
    const title =
        data?.title ||
        (showPreview ? "Servicios Destacados" : "Todos Nuestros Servicios");
    const subtitle =
        data?.subtitle ||
    ...
    return (
        <section
            ...
            className="py-16 md:py-24 px-4 bg-primary relative overflow-hidden"
        >
                                    ...
                                    <div className="relative z-10 p-6 flex flex-col items-center text-center h-full">
                                        ...
                                        >
                                            {service.image ? (
                                                ...
                                                <div className="relative">
                                                    <div
                                                        className={`w-16 h-16 md:w-20 md:h-20 rounded-xl flex items-center justify-center transition-all duration-500 ${
                                                            hoveredIndex ===
                                                            index
                                                    ...
                                                    {/* Glow behind icon */}
                                                    <div
                                                        className={`absolute inset-0 -z-10 blur-xl rounded-xl transition-opacity duration-500 ${
                                                            hoveredIndex ===
                                                            index
                                                                ? "opacity-60 bg-accent"
                                                                : "opacity-0"
                                        ...
                                        {/* Title */}
                                        <h3
                                            className={`text-base md:text-lg font-semibold mb-2 transition-all duration-300 ${
                                                hoveredIndex === index
                                                    ? "customtext-accent"
                                                    : "text-white"
                                            }`}
                                        ...
                                        {/* Description */}
                                        <p
                                            className="text-white text-sm leading-relaxed line-clamp-3 flex-grow"
