...
const ProductDetailNgs = ({
    ...
    return (
        <main id={data?.element_id || null} className="bg-sections-color min-h-screen text-neutral-dark py-12 mx-auto ">
            <div className="w-full 2xl:max-w-7xl px-primary 2xl:px-0 mx-auto">
                ...
                >
                    ...
                    <div className="col-span-12 lg:col-span-6 space-y-6">
                        ...
                        <h1
                            itemProp="name"
                            className="text-4xl md:text-5xl xl:text-6xl font-title font-bold text-neutral-dark tracking-tight leading-tight"
                        >
                        ...
                        {currentProduct?.description && (
                            <div
                                className="text-neutral-light text-base font-title leading-relaxed prose max-w-none [&>p]:m-0"
                        ...
                        {generalSpecifications.length > 0 && (
                            <div className="border border-slate-200 bg-slate-50/70 rounded-2xl overflow-hidden shadow-xs">
                                <div className="bg-slate-100/80 px-5 py-3 border-b border-slate-200 flex items-center gap-2">

                                    <span className="text-sm font-bold uppercase tracking-wider text-neutral-dark">
                                ...
                                <div className="relative w-full">
                                    {pdfFiles.length === 1 ? (
                                        <a
                                            ...
                                            className="w-full py-3.5 px-6 bg-slate-100 hover:bg-slate-200 text-neutral-dark rounded-full font-bold text-xs md:text-sm uppercase tracking-wider flex items-center justify-center gap-2 transition-all shadow-xs"
                                        >
                                        ...
                                        <>
                                            ...
                                            {isPdfDropdownOpen && (
                                                <div className="absolute bottom-full left-0 right-0 mb-2 bg-white border border-slate-200 shadow-xl rounded-2xl z-50 p-2 space-y-1">
                                                    <p className="text-xs font-bold text-slate-400 px-3 py-1 uppercase">Documentos Disponibles:</p>
                                ...
                                {advisors.length > 1 ? (
                                    <>
                                        <button
                                            ...
                                            className="w-full py-4 px-6 bg-accent hover:bg-primary text-white rounded-full font-bold text-sm md:text-base uppercase tracking-wider flex items-center justify-center gap-3 transition-all duration-300 shadow-lg hover:shadow-accent/25 active:scale-[0.99]"
                                        >
                                        ...
                                        {isAdvisorDropdownOpen && (
                                            <div className="absolute top-full left-0 right-0 mt-2 bg-white border border-slate-200 shadow-xl rounded-2xl z-50 p-2 space-y-1">
                                                <p className="text-xs font-bold text-slate-400 px-3 py-1 uppercase">Selecciona un asesor:</p>
