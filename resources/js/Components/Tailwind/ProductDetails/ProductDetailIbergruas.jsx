...
import ProductIbergruasSwiper from "../Products/ProductIbergruasSwiper";
...
const ProductDetailIbergruas = ({ item, data, setCart, cart, generals, favorites, setFavorites }) => {
            ...
            <div className="max-w-7xl mx-auto px-4 py-4 lg:py-8">
                <div className="grid lg:grid-cols-2 gap-6 lg:gap-12">
                    ...
                    <div className="space-y-3 lg:space-y-4">
                        ...
                        <div className="relative   overflow-hidden">
                            <div
                                className={`aspect-square flex items-center justify-center  relative ${isZoomEnabled ? 'cursor-zoom-out' : 'cursor-zoom-in'
                                    }`}
                    ...
                    <div className="space-y-4 lg:space-y-6 pb-20 lg:pb-0 overflow-x-hidden">
                        ...
                        <div className="flex flex-row  items-center justify-between gap-3">
                            {item?.category && (
                                <span className="bg-accent bg-opacity-10 customtext-neutral-dark font-bold px-3 py-1 sm:px-4 sm:py-2 rounded-none text-xs sm:text-sm">
                                    {item.category.name}
                                </span>
                            )}
                            {item?.brand && (
                        ...
                        {/* Título y rating */}
                        <div>
                            <h1 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-title font-bold customtext-primary  mb-3">
                                {item?.name}
                            </h1>
                                    ...
                                    {item.specifications.map(
                                        (spec, index) =>
                                            spec.type === "principal" && (
                                                ...
                                                >
                                                    <CheckCircle className="customtext-primary w-4 h-4 flex-shrink-0" />
                                                    <span className="font-bold customtext-primary">
                                    ...
                                    <div>
                                        ...
                                        {hasDiscount && (
                                            <div className="flex items-center space-x-2 mt-1">
                                                ...
                                                <span className="bg-red-100 customtext-primary px-2 py-1 rounded-full text-sm font-bold">
                                                    Ahorras {formatPrice(parseFloat(item.price) - parseFloat(item.final_price))}
                                                </span>
                                            </div>
                                        )}
                ...
                {relationsItems && relationsItems.length > 0 && (
                    <ProductIbergruasSwiper
                        ...
                        data={{
                            title: `${item?.category.name || "Productos"    } relacionados`,
                            description: `${item?.category.name || "Productos"    } originales: Calidad, fiabilidad y durabilidad.`,
                            link_catalog: "/catalogo",
                            class_button: "bg-primary text-white hover:bg-primary/90",
                            class_content_header: "text-start"
                        }}
                        setCart={setCart}
                        cart={cart}
                    />
...
export default ProductDetailIbergruas;
