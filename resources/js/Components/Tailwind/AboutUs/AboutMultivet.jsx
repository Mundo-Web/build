...
const AboutMultivet = ({ data, filteredData, items }) => {
    ...
    return (
        <main
            ...
            className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 px-4 md:px-6 2xl:px-0 2xl:max-w-7xl mx-auto w-full py-8 md:py-12 lg:py-16"
        >
            {/* Hero Section */}
            <motion.section
                initial="initial"
                        ...
                        if (isLongText) {
                            ...
                            return (
                                <div className="max-w-5xl mx-auto text-center">
                                    <div
                                        className="customtext-neutral-dark text-base md:text-lg  leading-relaxed"
                                        dangerouslySetInnerHTML={{
                                            __html:
                                                history?.description?.replace(
                                                    /<p><br><\/p>/g,
                ...
                >
                    ...
                    >
                        <motion.div
                            ...
                            {...cardHover}
                        >
                            <motion.h3 className="text-3xl md:text-2xl lg:text-3xl xl:text-5xl font-bold customtext-secondary font-title mb-4 md:mb-6">
                                <TextWithHighlight
                                    text={mision?.title}
                                    className="font-title"
                                />
