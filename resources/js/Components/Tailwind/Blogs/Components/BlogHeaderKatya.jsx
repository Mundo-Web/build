        ...
        <main className="bg-white font-title">
            ...
            <section className="px-primary 2xl:px-0 2xl:max-w-7xl mx-auto py-8">
                <div className="space-y-4">
                    ...
                    <h1 className={`font-title text-4xl md:text-5xl 2xl:text-6xl font-semibold tracking-tight ${data?.class_title || 'customtext-neutral-dark'}`}>
                     Noticias destacas
                    </h1>

                        <p className="customtext-neutral-dark opacity-80 text-sm 2xl:text-lg font-title">
                ...
                {/* Featured Posts */}
                <div className="mt-4 lg:mt-0 flex gap-8 py-[2.5%] rounded-2xl">
