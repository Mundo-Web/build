...
export default function BlogHeaderMultivet({
    ...
    return (
        <main
            className={`relative bg-sections-color ${isFilter ? "" : "min-h-screen"} font-title`}
        >
                ...
                <div className="relative px-4 2xl:px-0 2xl:max-w-7xl mx-auto">
                    ...
                    >
                        <motion.h1
                            ...
                            className={` text-4xl md:text-6xl 2xl:text-5xl max-w-6xl mx-auto font-bold text-secondary font-title leading-tight ${data?.class_title || ""}`}
                        >
                            {data?.title ? (
                                <span
                    ...
                    {!isFilter && headerPosts && headerPosts.length > 0 && (
                        ...
                        >
                            <div className="text-center mb-8">
                                <h2 className="text-4xl md:text-5xl font-bold mb-6 font-title text-secondary leading-tight">
