        ...
        return (
            ...
            >
                <div className="max-w-7xl mx-auto px-primary text-center">
                    <h2 className="text-3xl font-title md:text-4xl font-bold mb-4 text-secondary">
        ...
        >
            <div className="2xl:max-w-7xl mx-auto px-primary 2xl:px-0">
                ...
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-title md:text-5xl font-bold mb-4 text-secondary">
                        {data?.title || "Últimas Publicaciones del Blog"}
                    </h2>
                    {data?.subtitle && (
                        <p className="max-w-2xl mx-auto text-lg text-neutral-light">
                            {data.subtitle}
                        </p>
                    )}
                </div>
                ...
                <div className="relative">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {currentPosts.map((post) => (
                            ...
                            >
                                <article
                                    className={`bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group cursor-pointer h-full ${data?.class_card || ""}`}
                                >
                                    <div className="relative overflow-hidden">
                                        ...
                                        {post.category && (
                                            <div className="absolute top-4 left-4">
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-semibold bg-accent text-primary ${data?.class_badge_category || ""}`}
                                                >
                                                    {post.category?.name}
                                                </span>
                                            </div>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <h3 className="text-lg font-title font-bold mb-3 group-hover:text-secondary transition-colors line-clamp-2 text-primary">
                                            {post.name}
                                        </h3>

                                        <p className="text-sm mb-4 line-clamp-3 text-neutral-light">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="font-semibold text-sm flex items-center space-x-1 group-hover:translate-x-1 transition-transform text-secondary">
                                                <span>
                                                    {data?.read_more_text ||
                                                        "Leer más"}
                                                </span>
                ...
                {data?.blog_url && (
                    <div className="text-center mt-12">
                        ...
                        >
                            <span>
                                {data?.view_all_text || "Ver más artículos"}
                            </span>
