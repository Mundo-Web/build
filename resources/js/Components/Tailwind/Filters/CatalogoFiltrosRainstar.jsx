...
import ProductCardRainstar from "../Products/Components/ProductCardRainstar";
    ...
    return (
        ...
        >
            <div className="px-2 h-full">
                <div className="bg-white border-b-2 border-transparent hover:border-primary transition-all duration-300 h-full">
                    ...
                    <div className="flex flex-col h-[400px] lg:h-[460px] xl:h-[400px] 2xl:h-[430px]">
                        ...
                        <div className="py-6 space-y-4 bg-white flex-shrink-0">
                            {/* Marca skeleton */}
                            ...
                            <div className="flex items-center justify-between pt-4">
                                ...
                                <div className="h-10 w-10 bg-primary/5"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
const CatalogoFiltrosRainstar = ({
    ...
    const fetchProducts = async (page = 1, isNewFilter = false) => {
        ...
        try {
            ...
            const itemsPerPage = pagination.itemsPerPage || 24; // Usar valor dinámico del estado
    ...
    return (
        <section
            ...
            className="py-4 lg:py-16 bg-white"
        >
            <div className="mx-auto px-primary 2xl:px-0 2xl:max-w-7xl">
                {/* Header mejorado con estadísticas y acciones rápidas */}
                <motion.div
                    className="flex flex-col md:flex-row md:justify-between items-start md:items-center mb-6 lg:mb-12 lg:pb-8 lg:border-b-2 border-primary"
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                <div className="relative flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="w-full flex lg:hidden lg:mb-6  items-stretch gap-3">
                        ...
                        <motion.div className="flex-1 max-w-max">
                            ...
                            >
                                <motion.button
                                    className="w-full h-12 flex items-center justify-center gap-2 px-8 bg-primary text-white rounded-none hover:bg-neutral-900 transition-all duration-300"
...
export default CatalogoFiltrosRainstar;
