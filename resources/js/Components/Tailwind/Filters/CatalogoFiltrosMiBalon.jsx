...
import CardProductMiBalon from "../Products/Components/CardProductMiBalon";
import {
    ChevronDown,
    ChevronLeft,
    ChevronRight,
...
const modernFilterStyles = {
    filterContainer: "bg-white border border-gray-100 rounded-[2rem] shadow-lg",
    filterHeader: "bg-white border-b border-gray-100 rounded-t-[2rem]",
    filterSection:
        "group transition-all duration-300 hover:bg-neutral-50 rounded-2xl",
    filterButton:
    ...
    label: "flex items-center gap-3 py-1.5 px-3 rounded-lg transition-all duration-200 hover:bg-neutral-100 cursor-pointer group",
    activeFilter: "bg-primary text-white shadow-md",
    badge: "inline-flex items-center gap-1.5 px-3 py-1.5 bg-neutral-100 border border-gray-200 rounded-full text-sm font-bold text-neutral-dark hover:bg-neutral-200",
...
const CatalogoFiltrosMiBalon = ({
    ...
    const debugCompareWithHeaderSearch = async (query) => {
        ...
        // Filtros de CatalogoFiltrosMiBalon (con mejora inteligente)
        ...
        try {
            ...
            // Test con filtros de CatalogoFiltrosMiBalon (mejorados)
    ...
    return (
        ...
        >
            <div className="mx-auto px-primary 2xl:px-0 2xl:max-w-7xl">
                ...
                <motion.div
                    className="flex flex-col md:flex-row md:justify-between items-start md:items-center mb-6 lg:mb-8 lg:pb-6 "
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-neutral-dark hidden lg:block">
                                                        ...
                                                        <div className="space-y-2 max-h-[200px] overflow-y-auto custom-scrollbar">
                                                            <AnimatePresence>
                                                                ...
                                                                0 ? (
                                                                    ...
                                                                    <motion.div
                                                                        className="text-center py-6 text-neutral-dark"
                                                                        initial={{
                                                                            opacity: 0,
                                                                        }}
                                                                        animate={{
                                                                    ...
                                                                    (
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                ...
                                                                                />
                                                                                <span className="text-sm line-clamp-1 text-neutral-dark  transition-colors duration-200">
                                                                                    {
                                                                                        category.name
                                                                                    }
                                                                                </span>
                                                                                                ...
                                                                                                {category.subcategories.map(
                                                                                                    (
                                                                                                        ...
                                                                                                        >
                                                                                                            ...
                                                                                                            />
                                                                                                            <span className="text-sm line-clamp-1 text-neutral-dark group-hover:text-purple-600 transition-colors duration-200">
                                                                                                                {
                                                                                                                    sub.name
                                                                                                                }
                                                                                                            </span>
                                                                    ...
                                                                    filteredSubcategories.map(
                                                                        (
                                                                            ...
                                                                            >
                                                                                ...
                                                                                />
                                                                                <span className="text-sm line-clamp-1 font-medium text-neutral-dark transition-colors duration-200">
                                                                                    {
                                                                                        subcategory.name
                                                                                    }
                                                                                </span>
                    ...
                    >
                                        ...
                                        >
                                            <div className="text-center space-y-6">
                                                ...
                                                >
                                                    ...
                                                    <motion.button
                                                        className="mt-4 px-6 py-3 bg-primary text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                                                        onClick={() => {
                                                            // Limpiar cada filtro individualmente usando setSelectedFilters con función
                                                            // Esto simula el comportamiento de handleFilterChange que funciona correctamente
                                                            setSelectedFilters(
                        ...
                        {Array.isArray(products) && products.length > 0 && (
                            ...
                            >
                                ...
                                <div className="text-primary font-semibold w-full md:w-auto">
...
export default CatalogoFiltrosMiBalon;
