...
const SliderPideloPe = ({ items, data }) => {
                ...
                {items.map((item, index) => (
                    <SwiperSlide key={index}>
                        <motion.div
                            ...
                            className="h-[760px] lg:h-[500px] rounded-3xl relative flex flex-col lg:flex-row overflow-hidden"
                            style={{
                                background: item.background
                                    ? item.background
                                    : `url(/storage/images/slider/${item.bg_image || "undefined"}) center/cover no-repeat`,
                            }}
                        >
                            {/* Imagen principal a la izquierda */}
                            <motion.div
                                className="flex-shrink-0 flex items-center justify-center w-full lg:w-1/2 h-[300px] lg:h-full"
                            ...
                            {/* Textos a la derecha */}
                            <motion.div 
                                className="p-5 py-8 lg:max-w-2xl lg:px-16 flex flex-col justify-center items-start lg:h-full z-10 w-full lg:w-1/2 text-left"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                            ...
                            >
                                <div className="flex flex-col gap-5 lg:gap-5 items-start">
                                    <motion.h2
                                        className="w-full text-[32px] font-bold leading-9 lg:text-6xl"
                                    ...
                                    <motion.p
                                        className="my-2 w-full customtext-neutral-light text-sm leading-tight"
                                        style={{ textShadow: "0 0 20px rgba(0, 0, 0, .25)" }}
                                    ...
                                    <motion.a
                                        ...
                                        className="bg-primary z-50 my-1 w-max h-11 flex items-center justify-center rounded-full text-white text-sm font-semibold px-10"
