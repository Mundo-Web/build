...
const SliderFirstClass = ({ sliders = [], data }) => {
    ...
    const defaultSlides = [
        {
            ...
            description:
                "Servicio de mensajería internacional de primera clase para personas, empresas y negocios con la mejor tecnología y seguimiento en tiempo real.",
        ...
        },
        {
            ...
            description:
                "Obtén tu casillero virtual en Miami y accede a miles de tiendas estadounidenses. Compra productos originales al mejor precio y recíbelos en tu país.",
            ...
            bg_image:
                "https://images.pexels.com/photos/4246148/pexels-photo-4246148.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop",
        ...
        },
        {
            ...
            description:
                "Servicios de importación y exportación para empresas. Asesoría personalizada en trámites aduaneros y logística internacional optimizada.",
    ...
    return (
        <section
            ...
            className={`relative overflow-hidden ${data?.class_slider || ""}`}
            style={{ margin: 0, padding: 0 }}
        >
            {/* Background with gradient and image */}
            <div
                className={`absolute inset-0 bg-gradient-to-br ${currentSlideData.bgGradient || "from-primary to-secondary"} transition-all duration-1000 ease-in-out ${data?.class_overlay || ""}`}
            >
            ...
            {/* Slide Indicators */}
            <div
                className={`absolute bottom-6 lg:bottom-8 left-1/2 transform -translate-x-1/2 z-30 flex space-x-3 ${data?.class_indicators || ""}`}
            >
                {slides.map((_, index) => (
                    <button
                        key={index}
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            >
                                {currentSlideData.name && (
                                    <TextWithHighlight
                                        text={currentSlideData.name}
                                        color={`${data?.class_highlight_title || "bg-primary"}`}
                                    />
                                )}
                            </h2>
                            ...
                            <p
                                ...
                                style={{
                                    color:
                                        currentSlideData.description_color ||
                                        "#FFFFFF",
