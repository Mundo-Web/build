...
const SliderBoxed = ({ sliders, data }) => {
    ...
    return (
        <section
            ...
            className="bg-gradient-to-r from-[#c4b8d3] to-[#dbc8c9] md:px-[10%] md:py-[2.5%]"
        >
            <Swiper
            ...
            >
                {sliders.map((slide, index) => (
                    <SwiperSlide key={index}>
                        ...
                        >
                            <h2
                                className="text-2xl text-white w-2/3 lg:w-1/3"
                                data-aos="fade-down"
                            >
                                {em(slide.name)}
                            </h2>
                            <p
                                className="text-white py-4 w-2/3 lg:w-1/3"
                                data-aos="fade-up"
                            >
                                {slide.description}
                            </p>
