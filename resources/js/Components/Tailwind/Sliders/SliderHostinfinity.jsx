...
const SliderHostinfinity = ({ items, data, generals = [] }) => {
        ...
        >
            {sortedSlides.map((slide, index) => (
                ...
                >
                    ...
                    {/* Overlay gradiente lateral - estilo HeroSlider */}
                    ...
                    <div className={`relative h-full 2xl:max-w-7xl mx-auto px-[5%] 2xl:px-0 flex items-center ${data?.class_content_slider || ''}`}>
                        <div className="max-w-2xl">
                            ...
                            >
                                {/* Badge/Subtitle */}
                                {slide.subtitle && (
                                    <div className="inline-block mb-4 px-4 py-2 bg-gradient-to-r from-blue-600/90 to-purple-600/90 backdrop-blur-sm rounded-full">
                                ...
                                <div className={`flex flex-col sm:flex-row items-start gap-4 ${data?.class_buttons_container || ''}`}>
                                    {slide.button_link && slide.button_text && (
                                        <a
                                            ...
                                            className={`group inline-flex items-center justify-center px-8 py-3.5 text-lg font-semibold rounded-lg transition-all duration-300 bg-gradient-to-r from-secondary-500 to-secondary-400 hover:from-secondary-600 hover:to-secondary-500 text-black shadow-[0_0_25px_rgba(139,92,246,0.6)] hover:shadow-[0_0_35px_rgba(139,92,246,0.8)] hover:scale-105 hover:brightness-110 relative overflow-hidden ${data?.class_button || ''}`}
                                        >
                                            {slide.button_text}
                                    ...
                                    {slide.secondary_button_link && slide.secondary_button_text && (
                                        <a
                                            ...
                                            className={`inline-flex items-center justify-center px-8 py-3.5 text-lg font-semibold rounded-lg transition-all duration-300 bg-transparent border-2 border-secondary-500/40 text-secondary-400 hover:bg-secondary-500/10 hover:border-secondary-500 ${data?.class_secondary_button || ''}`}
                                        >
...
export default SliderHostinfinity;
