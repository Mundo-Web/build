...
import { EffectFade, Autoplay, Navigation, Pagination, A11y, Keyboard } from 'swiper/modules';
import 'swiper/css';
...
const SliderLaPetaca = ({ items, data, generals = [] }) => {
    ...
    const titleVariants = {
        ...
        animate: { opacity: 1, y: 0, scale: 1, transition: { duration: 1.4, delay: 1.2, ease: "easeOut" } },
        exit: { opacity: 0, y: -30, scale: 0.9, transition: { duration: 0.7, ease: "easeInOut" } }
    };
    const descriptionVariants = {
        initial: { opacity: 0, y: 40, filter: "blur(10px)" },
        animate: { opacity: 1, y: 0, filter: "blur(0px)", transition: { duration: 1.1, delay: 2.0, ease: "easeOut" } },
        exit: { opacity: 0, y: -20, filter: "blur(8px)", transition: { duration: 0.5, ease: "easeInOut" } }
    };
    const buttonsVariants = {
        initial: { opacity: 0, y: 40, scale: 0.9 },
        animate: { opacity: 1, y: 0, scale: 1, transition: { duration: 1.0, delay: 3.0, ease: "easeOut" } },
        exit: { opacity: 0, y: 20, scale: 0.8, transition: { duration: 0.4, ease: "easeInOut" } }
    };
    ...
    return (
        <section id={data?.element_id || null} className={`relative h-screen w-full overflow-hidden ${sliderClass}`}>
            <Swiper
                ...
                speed={3200}
                autoplay={{ delay: autoplayDelay < 3500 ? 3500 : autoplayDelay, disableOnInteraction: false }}
                a11y={{ enabled: true }}
                loop
