...
const CategoryOneLine = React.lazy(
    () => import("./Categories/CategoryOneLine"),
);
const CategoryPrettyGrid = React.lazy(
    () => import("./Categories/CategoryPrettyGrid"),
);
const CategoryCarousel = React.lazy(
    () => import("./Categories/CategoryCarousel"),
);
const InfiniteCategory = React.lazy(
    () => import("./Categories/InfiniteCategory"),
);
const PaginationCategory = React.lazy(
    () => import("./Categories/PaginationCategory"),
);
const CategoryFlex = React.lazy(() => import("./Categories/CategoryFlex"));
const CategoryGridInfinite = React.lazy(
    () => import("./Categories/CategoryGridInfinite"),
);
const CategoriesScraping = React.lazy(
    () => import("./Scraping/Components/CategoriesScraping"),
);
const CategoryBoxSwiper = React.lazy(
    () => import("./Categories/CategoryBoxSwiper"),
);
const CategoryPidelo = React.lazy(() => import("./Categories/CategoryPidelo"));
const CategoryInfiniteSlider = React.lazy(
    () => import("./Categories/CategoryInfiniteSlider"),
);
