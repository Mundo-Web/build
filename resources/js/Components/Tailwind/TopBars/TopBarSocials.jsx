    ...
    return (
        ...
        >
            <div className="px-primary  mx-auto py-1.5 flex flex-wrap justify-center md:justify-between items-center gap-2 2xl:max-w-7xl 2xl:px-0">
                <p
                    className={`hidden md:block text-xs ${data?.class_copyright || ""}`}
                >
                    {data?.isCopyright ? (
                        <>
                            {content}
                ...
                <div className="flex gap-4">
                    {items && items.length > 0 ? (
                        items.map((social, index) => {
                            ...
                            const socialData = predefinedSocials.find(
                                (s) =>
                            ...
                            return (
                                ...
                                >
                                    <a
                                        className={`text-xl w-8 h-8 flex items-center justify-center rounded-full p-2 ${data?.class_icon ? data?.class_icon : "text-primary"} hover:scale-110 transition-transform duration-200 cursor-pointer`}
