...
const ProductMultivet = ({
    ...
    if (!items || items.length === 0) {
        return <div className="hidden w-full px-primary p-4 mx-auto"></div>;
    }
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <motion.div ref={headerRef} className="text-center mb-12">
                    <motion.h2
                        ...
                        className={`text-3xl md:text-5xl font-bold text-secondary mb-4 font-title ${data?.class_title || ""}`}
                    >
                    ...
                    {data?.description && (
                        <motion.p
                            ...
                            initial="hidden"
                            animate={headerInView ? "visible" : "hidden"}
                            className="text-neutral-light text-lg max-w-2xl mx-auto"
                        >
                            {data?.description}
                        </motion.p>
                    )}
                            ...
                            <button
                                ...
                                className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                                    selectedCategory === category
                                        ...
                                        : "bg-white text-neutral-light hover:bg-primary hover:text-white border border-gray-300"
                                }`}
                            >
                                {category}
                            </button>
                ...
                {data?.button_top && data?.link_catalog && (
                    <div className="text-center my-12">
                        <motion.a
                            ...
                            className={`inline-flex items-center gap-3 px-8 py-4 bg-primary font-bold text-primary  rounded-lg hover:bg-secondary hover:text-white transform hover:scale-105 transition-all duration-300 ${data?.class_button || ""}`}
