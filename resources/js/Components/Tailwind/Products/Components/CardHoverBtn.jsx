            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <span className="flex gap-2 text-sm items-center font-semibold">
                                {" "}
                                Ver <LucideEye width="1.2rem" />
                            </span>
                        </motion.button>
                        <motion.button
                            aria-label="Agregar al carrito"
                    ...
                    <div>
                        <p
                            className={`text-xs  font-semibold mb-1 ${data?.class_card_subtitle || "customtext-neutral-light"}`}
                        >
                            {product?.brand?.name || product?.category?.name}
                        </p>
                        <h3
                            className={`customtext-neutral-dark text-lg font-semibold mb-2 line-clamp-3 h-20 ${data?.class_card_title}`}
                        >
                            {product.name}
                        </h3>
                        ...
                        {data?.is_short_description && (
                            <p
                                className={`text-sm customtext-neutral-light mb-2 ${product.discount != null && !isNaN(product.discount) ? "!line-clamp-1 !h-4" : "!line-clamp-2"} ${data?.class_card_description}`}
