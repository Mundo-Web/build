...
const Services = ({ service_categories = [], service_sub_categories = [] }) => {
    ...
    const addSpecification = () => {
        setSpecifications([...specifications, { id: null, type: 'general', title: '', description: '' }]);
    };
    ...
    const onModalOpen = (data) => {
        ...
        if (data?.specifications && Array.isArray(data.specifications)) {
            setSpecifications(data.specifications.map(s => ({
                id: s.id,
                type: s.type || 'general',
                title: s.title,
        ...
        const deletedInputs = document.querySelectorAll('.deleted-image-input, .deleted-pdf-input, .deleted-video-input');
    ...
    const onModalSubmit = async (e) => {
        ...
        const deletedImageInputs = document.querySelectorAll('.deleted-image-input');
        const deletedImages = Array.from(deletedImageInputs).map(input => input.value);
        ...
        const deletedPdfInputs = document.querySelectorAll('.deleted-pdf-input');
        const deletedPdfs = Array.from(deletedPdfInputs).map(input => input.value);
        ...
        const deletedVideoInputs = document.querySelectorAll('.deleted-video-input');
        const deletedVideos = Array.from(deletedVideoInputs).map(input => input.value);
                                    ...
                                    <div className="card border-0 shadow-sm h-100">
                                        ...
                                        <div className="card-body">
                                            <SelectFormGroup
                                                ...
                                                hidden={!Fillable.has('services', 'service_category_id')}
                                            >
                                            ...
                                            <SelectFormGroup
                                                ...
                                                label="Subcategoría"
                                                dropdownParent="#principal-container"
                                                hidden={!Fillable.has('services', 'service_subcategory_id')}
                                            >
                                    ...
                                    <div className="card border-0 shadow-sm">
                                        ...
                                        <div className="card-body">
                                            <TextareaFormGroup
                                                ...
                                                hidden={!Fillable.has('services', 'summary')}
                                            />
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div className="gallery-container" style={{
                                                    ...
                                                    <div
                                                        ...
                                                        onMouseLeave={(e) => {
                                                            ...
                                                            e.currentTarget.style.borderColor = '#71b6f9';
                                                            e.currentTarget.style.transform = 'scale(1)';
                                                        }}
                                                    >
                                                ...
                                                <div className="mb-4">
                                                    ...
                                                    {pdfs.map((pdf, index) => (
                                                        <div
                                                            ...
                                                            onDrop={(e) => handlePdfDropReorder(e, index)}
                                                            className="list-group-item d-flex align-items-center justify-content-between"
                                                            style={{
                                                                cursor: 'grab',
                                                                opacity: draggedPdfIndex === index ? 0.5 : 1,
                                                                backgroundColor: draggedPdfIndex === index ? '#f8f9fa' : 'white',
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    {videos.map((video, index) => (
                                                        <div
                                                            ...
                                                            onDrop={(e) => handleVideoDropReorder(e, index)}
                                                            className="list-group-item d-flex align-items-center justify-content-between"
                                                            style={{
                                                                cursor: 'grab',
                                                                opacity: draggedVideoIndex === index ? 0.5 : 1,
                                                                backgroundColor: draggedVideoIndex === index ? '#f8f9fa' : 'white',
                                                                transition: 'all 0.2s ease'
                                                            }}
                                                        >
                                        ...
                                        <div className="card border-0 shadow-sm h-100">
                                            ...
                                            {features.length === 0 ? (
                                                <div className="alert alert-info mb-0">
                                                    ...
                                                    No hay características agregadas. Haz clic en "Agregar" para comenzar.
                                                </div>
                                            ) : (
                                                    ...
                                                    <div key={index} className="card mb-3 border">
                                                        <div className="card-body">
                                                            <div className="d-flex justify-content-between align-items-start mb-2">
                                                                <label className="form-label mb-0">Característica #{index + 1}</label>
                                                                <button
                                                                    type="button"
                                                                    className="btn btn-sm btn-outline-danger"
                                            ...
                                            <button
                                                ...
                                                onClick={addFeature}
                                            >
                                                <i className="mdi mdi-plus me-1"></i> Agregar Característica
                                            </button>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div className={`${Fillable.has('services', 'is_features') && Fillable.has('services', 'is_specifications')  ? 'col-md-6' : 'col-12'}`}>
                                        <div className="card border-0 shadow-sm h-100">
                                            ...
                                            {specifications.length === 0 ? (
                                                <div className="alert alert-info mb-0">
                                                    <i className="mdi mdi-information me-2"></i>
                                                    No hay especificaciones agregadas. Haz clic en "Agregar" para comenzar.
                                                </div>
                                            ) : (
                                                    ...
                                                    <div key={index} className="card mb-3 border">
                                                        <div className="card-body">
                                                            <div className="d-flex justify-content-between align-items-start mb-3">
                                                                <label className="form-label mb-0">Especificación #{index + 1}</label>
                                                                <button
                                                                    type="button"
                                                                    className="btn btn-sm btn-outline-danger"
                                            ...
                                            >
                                                <i className="mdi mdi-plus me-1"></i> Agregar Especificación
                                            </button>
                                        </div>
                                    </div>
                                    </div>
