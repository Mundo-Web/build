  ...
  return (<>
      ...
      columns={[
        ...
        },
        {
          ...
          cellTemplate: (container, { data }) => {
            ReactAppend(container, <img src={`/storage/images/benefit/${data.image}`} style={{ width: '80px', height: '80px', objectFit: 'cover', objectPosition: 'center', borderRadius: '4px' }} onError={e => e.target.src = '/api/cover/thumbnail/null'} />)
          }
        },
        {
          dataField: 'visible',
    ...
    <Modal modalRef={modalRef} title={isEditing ? 'Editar beneficio' : 'Agregar beneficio'} onSubmit={onModalSubmit} size='md'>
      <div className='row' id='benefits-container'>
        ...
        <InputFormGroup eRef={nameRef} label='Beneficio' col='col-12' required />
        <TextareaFormGroup eRef={descriptionRef} label='Descripción' rows={3} />
        <ImageFormGroup eRef={imageRef} name="image" label='Imagen' col='col-12' />
      </div>
    </Modal>
  </>
  )
